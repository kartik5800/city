...
//                                     userType === 'Login' ?
//                                         <div className='text-center buttons'>
//                                             <span>Create New Account</span><a style={{color: "red"}} onClick={() => setUserType('Signup')}> Signup</a>
//                                         </div>
//                                         :
//                                         <div className='text-center'>
//                                             <span>Already have Account</span><a style={{color: "red"}} onClick={() => setUserType('Login')}> Login</a>
//                                         </div>
//                                 }
